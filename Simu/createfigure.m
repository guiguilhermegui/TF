...
%  Auto-generated by MATLAB on 18-Jan-2025 18:27:04
...
% datatip(plot1,140,0.467572623401186);
% Create datatip
datatip(plot1,'DataIndex',140);

% The following line demonstrates an alternative way to create a data tip.
% datatip(plot1,353,0.17141623100446);
% Create datatip
datatip(plot1,'DataIndex',353);

% The following line demonstrates an alternative way to create a data tip.
% datatip(plot1,220,0.320752020388951);
% Create datatip
datatip(plot1,'DataIndex',220);
